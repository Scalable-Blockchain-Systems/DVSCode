...
if [ "$CC_SRC_LANGUAGE" = "javascript" ]; then
	CC_SRC_PATH="../chaincode/PowerContract/"
  CC_SRC_PATH1="../chaincode/AesoMarket/"
  CC_SRC_PATH2="../chaincode/VSIContract/"
else
...
#./network.sh deployCC -ccn PowerContract -ccv 1 -cci initLedger -ccl ${CC_SRC_LANGUAGE} -ccp ${CC_SRC_PATH}

./network.sh deployCC -ccn VSIContract -ccv 1 -cci initLedger -ccl ${CC_SRC_LANGUAGE} -ccp ${CC_SRC_PATH2}
popd
